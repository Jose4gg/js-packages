        ...
        return {
          FunctionDeclaration(node) {
            ...
            const verbPrefixes = [
              ...
              'fetch', 'handle', 'validate'
            ];

            const hasVerbPrefix = verbPrefixes.some(prefix => 
    ...
    'require-named-parameters': {
      create(context) {
        ...
        function checkFunctionParameters(node, context) {
          ...
          if (firstParamTypeAnnotation?.type === 'TSObjectType' || 
...
// Common configuration for both NestJS and React projects
module.exports = {
  plugins: {
